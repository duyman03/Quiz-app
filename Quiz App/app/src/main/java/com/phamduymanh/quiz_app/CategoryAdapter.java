...
import com.phamduymanh.quiz_app.databinding.ListItemBinding;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(holder.getAdapterPosition()==0){
                    HistoryFragment.setTopic("Toán học");
                }else if(holder.getAdapterPosition() == 1){
                    HistoryFragment.setTopic("Điện ảnh");
                }else if(holder.getAdapterPosition() == 2){
                    HistoryFragment.setTopic("Công nghệ");
                }else if(holder.getAdapterPosition() == 3){
                    HistoryFragment.setTopic("Bóng đá");
                }else if(holder.getAdapterPosition() == 4){
                    HistoryFragment.setTopic("Sinh học");
                }else if(holder.getAdapterPosition() == 5){
                    HistoryFragment.setTopic("Địa lý");
                }
